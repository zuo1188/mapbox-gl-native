...
namespace android {
     ...
     */
    CircleLayer::CircleLayer(mbgl::style::Style& style, mbgl::style::CircleLayer& coreLayer)
     ...
     */
    CircleLayer::CircleLayer(mbgl::style::Style& style, std::unique_ptr<mbgl::style::CircleLayer> coreLayer)

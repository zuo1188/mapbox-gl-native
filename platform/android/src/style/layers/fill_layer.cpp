...
namespace android {
     ...
     */
    FillLayer::FillLayer(mbgl::style::Style& style, mbgl::style::FillLayer& coreLayer)
     ...
     */
    FillLayer::FillLayer(mbgl::style::Style& style, std::unique_ptr<mbgl::style::FillLayer> coreLayer)
